    ...
    <div id="temCategItem" class="is-hide">
        <li class="tab-item">
            <span class="tab-item-link">
                <i class="icon icon-mask CategIcon"></i>
                <span class="title language_replace CategName"></span>
            </span>
        </li>
    </div>
    <div id="temGameSection" class="is-hide">
            <section class="section-wrap section-levelUp" style="z-index: 99;">
                <div class="container-fluid">
                    <div class="game_wrapper">
                         <div class="sec-title-container">
                            <div class="sec-title-wrapper">
                                <h3 class="sec-title"><i class="icon icon-mask icon-poker"></i><span class="CategTagName"></span></h3>
                            </div>
                        </div>
                        <div class="game_slider swiper_container gameinfo-hover round-arrow">
                            <div class="swiper-wrapper">
                            </div>
                             <div class="swiper-button-next"></div>
                            <div class="swiper-button-prev"></div>
