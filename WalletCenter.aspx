            ...
            <section class="section-wrap">
                <div class="box-item-container walletcenter-menu">
                   <div class="box-item">
                    ...
                    <%--<div class="box-item">
                        <a class="box-item-link" onclick="window.parent.API_LoadPage('UserAccountEventBonusHistory','UserAccountEventBonusHistory.aspx', true)">
                            <div class="box-item-inner tab">
                                <i class="icon icon-coin"></i>
                                <div class="box-item-detail">
                                    <div class="box-item-title language_replace">活動領取紀錄</div>
                                </div>
                            </div>
                        </a>
                    </div>--%>
