                    ...
                    <section class="section-member-profile">
                        ...
                        <div class="member-profile-data-wrapper dataList">
                            <fieldset class="dataFieldset">
                                <legend class="sec-title-container sec-title-member sec-col-2">
                                ...
                                <div class="dataFieldset-content row no-gutters">
                                    ...
                                    <div class="data-item birth" style="width: 50%">
                                        ...
                                        <div class="data-item-content">
                                            <input type="text" style="" class="custom-input-edit year" id="idBornYear" value="" readonly>
                                            / <input type="text" style="" class="custom-input-edit month" id="idBornMonth" value="" readonly>
                                            / <input type="text" style="" class="custom-input-edit day" id="idBornDay" value="" readonly>
                                        </div>
                                    </div>
                                    <div class="data-item password" style="width: 50%; display: none;">
                                        <div class="data-item-title">
