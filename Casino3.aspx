    ...
    <section class="game-area">
        ...
        <section class="section-wrap section-levelUp">
            ...
            <div class="game_wrapper">
                ...
                <div class="game_slider swiper_container gameinfo-hover round-arrow" id="lobbyGame-1">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="game-item">
                                            ...
                                            <div class="game-item-info-hidden">
                                                <div class="top">
                                                    ...
                                                    <button type="button" class="btn game-item-btn btn-more">
                                                        <span class="language_replace">更多</span>
                                                    </button>
                                                </div>
                                                <div class="bottom">
                                                    <button type="button" class="btn btn-full-main btn-play">
                                                        <span class="language_replace">GO</span><i class="triangle"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
