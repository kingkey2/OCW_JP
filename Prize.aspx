            ...
            <div class="container">
                <div class="sec-title-container sec-title-prize">
                    ...
                    <div class="sec-title-wrapper">
                        ...
                        <span class="" onclick="window.parent.API_LoadPage('Prize','/Guide/prize.html', true)">
                            <span class="btn btn-QA-transaction btn-full-stress btn-round">
                                <i class="icon icon-mask icon-question"></i>
                            </span><span class="language_replace">領獎中心使用說明</span>
                        </span>
                        <!-- 獎金/禮金 TAB -->
