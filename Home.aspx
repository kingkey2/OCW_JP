...
<body class="innerBody"  style="height:auto">
    <main>
        ...
        <section class="section-wrap recommend">
            <div class="container">
                <div class="game_wrapper">
                    ...
                    <div class="game_slider swiper_container round-arrow" id="game-recommend">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="game-item">
                            ...
                            <div class="swiper-slide">
                                <div class="game-item">
                                    <div class="game-item-inner">
                                        <span class="game-item-link"></span>
                                        <div class="img-wrap">
                                            <img src="http://ewin.dev.mts.idv.tw/Files/GamePlatformPic/PNG/PC/CHT/sweetalchemy.png">
                                        </div>
                                        <div class="game-item-info-hidden">
                                            <div class="game-item-btn">
                                                <button type="button" class="btn btn-full-main game-item-btn btn-try"><span class="language_replace">試玩</span></button>
        ...
        <!-- 最新遊戲 -->
        <section class="section-wrap new">
            <div class="container">
                <div class="game_wrapper">
                    <div class="sec_title_container">
                        <div class="sec_titl_wrapper">
                    ...
                    <div class="game_slider swiper_container round-arrow" id="game-new">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="game-item">
                                    <div class="game-item-inner">
        ...
        <section class="section-wrap pop">
            <div class="container">
                <div class="game_wrapper">
                    ...
                    <div class="game_slider swiper_container round-arrow" id="pop-casino">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="game-item">
                                    <div class="game-item-inner">
