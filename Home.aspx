    ...
    <div class="section">
        <div class="section1">
            <div class="content_area">
                <div class="main_girl">
                    <img src="images/newindex/main-girl.png" alt="" loading="lazy">
                </div>
                <div class="main_dog">
                    <img src="images/newindex/main-dog.png" alt="" loading="lazy">
                </div>
                ...
                <div class="img_777" style="animation-delay: 0.6s">
                    <img src="images/newindex/777.svg" alt="" loading="lazy">
                </div>
                <div class="img_chip_blue" style="animation-delay: 0s">
                    <img src="images/newindex/chip-blue.svg" alt="" loading="lazy">
                </div>
                <div class="img_chip_red" style="animation-delay: 1s">
                    <img src="images/newindex/chip-red.svg" alt="" loading="lazy">
                </div>
                ...
                <div class="img_dice" style="animation-delay: .2s">
                    <img src="images/newindex/dice.svg" alt="" loading="lazy">
                </div>
                <div class="img_card" style="animation-delay: 0s">
                    <img src="images/newindex/card.svg" alt="" loading="lazy">
                </div>
                <div class="img_diamond" style="animation-delay: .4s">
                    <img src="images/newindex/diamond.svg" alt="" loading="lazy">
                </div>
            </div>
        </div>
        <div class="section2">
            <div class="content_area">
                ...
                <div class="section2_girl">
                    ...
                    <img src="images/newindex/autumn-girl.png" alt="" loading="lazy">
                </div>
                <ul>
                    <li>
                        <span class="img_icon">
                            <img src="images/newindex/Slotgame.gif" alt="" loading="lazy"></span>
                        <span class="title">
                    ...
                    <li>
                        <span class="img_icon">
                            <img src="images/newindex/save.gif" alt="" loading="lazy"></span>
                        <span class="title">
                    ...
                    <li>
                        <span class="img_icon">
                            <img src="images/newindex/gift.gif" alt="" loading="lazy"></span>
                        <span class="title">
        ...
        <div class="section3">
            <div class="content_area">
                ...
                <div class="section3_girl">
                    <img src="images/newindex/girl-summer.png" alt="" loading="lazy">
                </div>
                <ul>
                    <li>
                        ...
                        <span class="imgrap">
                            <img src="images/newindex/phone1.svg" alt="" loading="lazy">
                        </span>
                    </li>
                    <li>
                        <span class="circlerap">
                        ...
                        <span class="imgrap">
                            <img src="images/newindex/phone2.svg" alt="" loading="lazy">
                        </span>
                    </li>
                    <li>
                        <span class="circlerap">
                        ...
                        <span class="imgrap">
                            <img src="images/newindex/phone3.svg" alt="" loading="lazy">
                        </span>
                    </li>
                </ul>
            </div>
        ...
        <div class="section4">
            <div class="content_area">
                <span class="girlhead">
                    <img src="images/newindex/girl-head.png" alt="" loading="lazy"></span>
            ...
            <div class="allgame">
                <div class="gamesection" style="animation-duration: 20s;">
                    ...
                    <div class="singlegame" title="バタフライブロッサム">
                        <img src="images/newindex/game10.jpg" alt="">
                        <p class="language_replace">蝶戀花</p>
                    </div><div class="singlegame" title="タイガージャングル">
                        <img src="images/newindex/game1.jpg" alt="">
                        <p class="language_replace">叢林之王-集鴻運</p>
                    </div>
                    <div class="singlegame" title="ワイルドファイヤーワークス">
                ...
                <div class="gamesection" style="animation-duration: 10s;">
                    ...
                    <div class="singlegame" title="スイートボナンザ">
                        <img src="images/newindex/game20.jpg" alt="">
                        <p class="language_replace">甜入心扉</p>
                    </div><div class="singlegame" title="ウェイズ オブ ザ キリン">
                        <img src="images/newindex/game11.jpg" alt="">
                        <p class="language_replace">麒麟送寶</p>
                    </div>
                    <div class="singlegame" title="ザ ドッグ ハウス">
                ...
                <div class="swiper mySwiper">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <div>
                            <img src="images/newindex/game-logo.png" class="videologo" alt="" loading="lazy">
                            <div class="relative aspect-video">
                                <div>
                                    <img src="images/newindex/game-video.jpg" class="" alt="" loading="lazy">
                                </div>
                            </div>
                        </div>
                      </div>
                      <div class="swiper-slide">
                        <div>
                            ...
                            <div class="relative aspect-video">
                                <div>
                                    <img src="images/newindex/game-video2.jpg" class="" alt="" loading="lazy">
                                </div>
                            </div>
                        </div>
                      </div>
                      <div class="swiper-slide">
                        <div>
                            ...
                            <div class="relative aspect-video">
                                <div>
                                    <img src="images/newindex/game-video3.jpg" class="" alt="" loading="lazy">
                                </div>
                            </div>
                        </div>
                      </div>
                      <div class="swiper-slide">
                        <div>
                            ...
                            <div class="relative aspect-video">
                                <div>
                                    <img src="images/newindex/game-video4.jpg" class="" alt="" loading="lazy">
                                </div>
                            </div>
                        </div>
                      </div>
                      <div class="swiper-slide">
                        <div>
                            ...
                            <div class="relative aspect-video">
                                <div>
                                    <img src="images/newindex/game-video5.jpg" class="" alt="" loading="lazy">
                                </div>
                            </div>
                        </div>
                      </div>
                      <div class="swiper-slide">
                        <div>
                            ...
                            <div class="relative aspect-video">
                                <div>
                                    <img src="images/newindex/game-video6.jpg" class="" alt="" loading="lazy">
                                </div>
                            </div>
                        </div>
                      </div>
        ...
        <div class="section5">
            <div class="content_area">
                ...
                <img src="images/newindex/7day.jpg" alt="" loading="lazy">
                <div class="events">
                    <div class="single_event month">
                        <div class="header"><span class="language_replace">每月優專的入金活動</span></div>
                        <div class="event_content">
                            <img src="images/newindex/month_01.jpg" alt="" loading="lazy">
                            <img src="images/newindex/month_02.jpg" alt="" loading="lazy">
                            <img src="images/newindex/month_03.jpg" alt="" loading="lazy">
                            <img src="images/newindex/month_04.jpg" alt="" loading="lazy">
                        </div>
                    </div>
                    <div class="single_event special">
                        <div class="header"><span class="language_replace">不定期的廠牌合作活動</span></div>
                        <div class="event_content">
                            <img src="images/newindex/act001.jpg" alt="" loading="lazy">
                            <img src="images/newindex/act002.jpg" alt="" loading="lazy">
                            <img src="images/newindex/act003.jpg" alt="" loading="lazy">
                            <img src="images/newindex/act004.jpg" alt="" loading="lazy">
                        </div>
                    </div>
                </div>
        ...
        <div class="section6">
            <div class="top_area">
                <div class="content_area">
                    <span class="section6_girl">
                        <img src="images/newindex/section6-girl.png" alt="" loading="lazy"></span>
                ...
                <span class="section6_wave">
                    <img src="images/newindex/section6-wave-bg.svg" alt="" loading="lazy"></span>
            </div>
            <div class="Character_area">
                <div class="Character_wrap">
                    <div class="Character Character_girl">
                        <div class="girl_intro">
                            <img class="-translate-x-6" src="images/newindex/girl-character.png" alt="" loading="lazy">
                            <h3>四葉 (よつば)</h3>
                    ...
                    <div class="Character Character_dig">
                        <div class="girl_intro">
                            <img class="-translate-x-6" src="images/newindex/dog-character.png" alt="" loading="lazy">
                            <h3>大吉</h3>
            ...
            <div class="dialogue_wrap">
                ...
                <img class="gd_head" src="images/newindex/girl-dog.png" alt="" loading="lazy">
                <div class="dialogue_content">
                    <div class="say dog_say">
                        ...
                        <img src="images/newindex/dialogue-dog.png" alt="" loading="lazy">
                    </div>
                    <div class="say girl_say">
                        <img src="images/newindex/dialogue-girl.png" alt="" loading="lazy">
        ...
        <div class="section7">
            <span class="section7_wave">
                <img src="images/newindex/section7-wave-bg.svg" alt="" loading="lazy"></span>
            <div class="flower left_flower">
                <img src="images/newindex/flower-left.png" alt="" loading="lazy">
            </div>
            <div class="flower right_flower">
                <img src="images/newindex/flower-right.png" alt="" loading="lazy">
            </div>
            <div class="content_area">
                <div class="word">
                    <h1>
