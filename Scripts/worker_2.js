...
self.addEventListener('message', function (e) {
    ...
    if (e.data) {
        if (e.data.Cmd == "Init") {
            wokerControl = new workerSelf(e.data.Params[0], e.data.Params[1]);
...
//#region  Class
var workerSelf = function (WebUrl, Second) {
    var workerSelf = this;        
    var APIUrl = WebUrl;
    ...
    this.Sync = function () {
        ...
        DBRequestLink.onupgradeneeded = function (event) {
            ...
            if (event.oldVersion == 0) {
                ...
                store.createIndex('GameBrand', 'GameBrand', { unique: false, multiEntry: false });
                store.createIndex('GameCategoryCode', 'GameCategoryCode', { unique: false, multiEntry: false });
                store.createIndex('GameCategorySubCode', ['GameCategoryCode', 'GameCategorySubCode'], { unique: false, multiEntry: false });                
