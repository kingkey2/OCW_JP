                ...
                if (t) {
                    switch (t) {
                        ...
                        case "8":
                            ...
                            break;
                        case "9":
                            GoActivityDetail(9, '/Activity/event/bng/09092022moonfestival/index-jp.aspx');
                            break;
                    }
                }
                ...
                <section class="section-wrap section-activity">
                    <div class="activity-item-group">
                        <figure class="activity-item">
                            <div class="activity-item-inner" onclick="GoActivityDetail(9,'/Activity/event/bng/09092022moonfestival/index-jp.aspx')">
                                <!-- 活動連結 -->
