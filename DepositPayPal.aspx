...
<script>      
    ...
    function CreatePayPalDeposit() {
        if ($("#amount").val() != '') {
            ...
            PaymentClient.CreatePayPalDeposit(WebInfo.SID, Math.uuid(), amount, paymentID, depositeToGiftCard, function (success, o) {
                if (success) {
                    let data = o.Data;
                    if (o.Result == 0) {
                                ...
                                <div class="form-group">
                                    <div class="btn-wrap btn-radio-wrap btn-radio-payment">
                                        ...
                                        <div class="btn-radio btn-radio-coinType">
                                            ...
                                            <label class="btn btn-outline-primary" for="amount2" data-val="20000" onclick="CoinBtn_Click()">
                                                <span class="coinType gameCoin">
                                        ...
                                        <div class="btn-radio btn-radio-coinType">
                                            ...
                                            <label class="btn btn-outline-primary" for="amount3" data-val="50000" onclick="CoinBtn_Click()">
                                                <span class="coinType gameCoin">
                                                    <%--<span class="coinType-title language_replace">遊戲幣</span>--%>
                                                    <span class="coinType-name">Ocoin</span>
