        ...
        <div class="page-content">
            <div class="manual-container">
                ...
                <div class="text-wrap">
                    ...
                    <strong><span><br />以下のようなことは不正行為とみなされ、勝利金の没収やアカウントの閉鎖につながる可能性があります。
                    <strong><span><br />• イコールマージンベット、ゼロリスクベット、ローマージンベット
                    <strong><span><br />• ソフトウェアの操作、抜け穴の悪用、その他の技術的な不正行為、またはその他の意図的な不正行為に相当する行為。
                    <strong><span><br />• ベットの結果に関わらず利益を得ることを最終目的として、同じベッティングマーケット内でプレイヤーまたはプレイヤーグループが一連の矛盾したベットを行った形跡がある場合。
                    <strong><span><br />• 2ティアベット<br />
                    <br />
...
<body>
                ...
                <div class="text-wrap">
                    ...
                    <p dir="ltr">
                        <strong>
                            ...
                            <br />以下行為判定為不正當使用Bonus，將視情況回收勝利獎金或封鎖帳號。
                            <br />‧等值下法、零風險下法、低利潤下法
                            <br />‧使用軟體、濫用漏洞、其他技術上的非法行為或有意地從事任何其他非法行為
                            <br />‧在同一投注場合內，玩家個人或團體無視投注結果以最終得利為目的連續進行明顯矛盾的下注之行為（如數個玩家對賭、打水）
                            <br />‧對沖投注<br /><br />
                            3.12<br />
    ...
    function appendGameFrame_M() {
        ...
        let tmp = `<div class="divGameFrameWrapper" style="height: 100%;width:100%">
            ...
            <div class="sidenav" style="height:5%; width: 100%; background-color: #132333">
                <button style="width: 30%; height: 100%" onclick="CloseGameFrame_M()" class="btnGameFrame_M"><i class="fa fa-home iGameFrame_M" aria-hidden="true"></i></button>
            </div>
        </div>`;
                        ...
                        for (var i = 0; i < o.GameBrandList.length; i++) {
                            ...
                            if (GBL.GameBrandState == 0) {
                                ...
                                if (GBL.GameBrandState == 0) {
                                    ...
                                    //GBL_img.src = `${EWinWebInfo.ImageUrl}/${gameItem.GameBrand}/ENG/${gameItem.GameName}.png`;
                                }
