...
<script type="text/javascript">
    ...
    function changeMultImg() {
        ...
        if (lang == "ENG") {
            $("#sec_HotArticle").hide();
            $("#OpenIntroBonus_Introduce").attr("onclick", "window.parent.API_LoadPage('OpenIntroBonus_03012022_EN', '/Activity/OpenIntroBonus_03012022_EN/index.html')");
            //$("#img_obd03012022").attr("src", "images/games/hero/OpenBonusDeposit-20220331.jpg");
            $("#img_oid03012022").attr("src", "images/games/hero/OpenIntroBonus-11_EN.jpg");
            $("#float_SideBar").hide();
        } else {
            $("#sec_HotArticle").show();
            $("#OpenIntroBonus_Introduce").attr("onclick", "window.parent.API_LoadPage('OpenIntroBonus_03012022', '/Activity/OpenIntroBonus_03012022/index.html')");
            //$("#img_obd03012022").attr("src", "images/games/hero/OpenBonusDeposit-20220331.jpg");
            $("#img_oid03012022").attr("src", "images/games/hero/OpenIntroBonus-11.jpg");
            $("#float_SideBar").show();
        }
    }
            ...
            <div class="swiper-container hero-main" id="hero">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide" style="background-image: linear-gradient(to right, #29040b 0%, #29040b 50%, #341f26 51%, #341f26 100%);">
                        <div class="hero-item">
                            <a id="OpenIntroBonus_Introduce">
                                <div class="img-wrap">
                                    <img id="img_oid03012022" src="images/games/hero/OpenIntroBonus-11.jpg" class="desktop">
                                    <img src="images/games/hero/OpenIntroBonus-11-m.jpg" class="mobile">
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="swiper-slide" style="background-color: #f3bd25">
                        <div class="hero-item">
                            <a onclick="window.parent.API_LoadPage('OpenBonusDeposit_03012022', '/Activity/OpenBonusDeposit_03312022/index.html')">
                                <div class="img-wrap">
                                        <img id="img_obd03012022" src="images/games/hero/OpenBonusDeposit-20220331.jpg"  class="desktop"/>
                                    <img src="images/games/hero/OpenBonusDeposit-20220331-m.jpg" class="mobile" />
                                </div>
                            </a>                  
                        </div>
                    </div>
                    <div class="swiper-slide" style="background-color: #13191e">
                        <div class="hero-item">
                            <div class="img-wrap">
                                <img src="images/games/hero/hero-11.jpg" class="desktop">
                                <img src="images/games/hero/hero-11-m.jpg" class="mobile">
                            </div>
                            <div class="hero-info">
                                <div class="hero-info-inner">
                                    <div class="hero-info-title language_replace">Play'n GO</div>
                                    <div class="hero-info-text">
                                        <p class="language_replace" style="font-size: .7em">はエンターテイメント性が高く、2019年にはその高レベルのゲーム性、グラフィックが評価され「Best Casino Supplier of the Year」を受賞、カジノマハラジャで遂にプレーオープン</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="page-content">
                    ...
                    <section class="section-wrap recommend">
                        ...
                        <div class="box-item-container recommend-list">
                            ...
                            <div id="idRecommend7" class="box-item">
                                <a class="box-item-link">
                                    <div class="box-item-inner">
                                        <div class="game-item">
                                            <div class="img-wrap">
                            ...
                            <div id="idRecommend8" class="box-item">
                                <a class="box-item-link">
                                    <div class="box-item-inner">
                                        <div class="game-item">
                                            <div class="img-wrap">
                    ...
                    <aside class="Sidebar_Right">
                        ...
                        <section class="section-wrap section-article" id="sec_HotArticle">
                            <div class="sec-title-container">
                                <div class="sec-title-wrap">
                                ...
                                <div class="article-list">
                                    <ul class="article-list-inner">
                                        <li class="article-item">
                                            <a onclick="window.parent.API_LoadPage('guide_strengths', '/Article/guide_strengths.html', false)" class="content">
                                                <h4 class="title language_replace">マハラジャの強み</h4>
                                        ...
                                        <li class="article-item">
                                            <a onclick="window.parent.API_LoadPage('guide_Rolling', 'Article/guide_Rolling.html', false)" class="content">
